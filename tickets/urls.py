...
urlpatterns = [
    ...
    path('vip-special-codes/download-status/<str:job_id>/', views.vip_special_codes_download_status, name='vip_special_codes_download_status'),
    path('vip-special-codes/download-file/<str:job_id>/', views.vip_special_codes_download_file, name='vip_special_codes_download_file'),
