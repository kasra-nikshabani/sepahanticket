...
def _extract_name(data):
    ...
    شکل دقیقِ فیلدهای `data` در مستندات زیبال نیامده، پس چند نام رایج
    امتحان می‌شود. پاسخ خام هم لاگ می‌شود تا بعد از اولین استعلام واقعی
    بتوانیم دقیقاً همان کلید را بگذاریم.
    """
