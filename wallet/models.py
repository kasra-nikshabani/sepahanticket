...
class WithdrawalRequest(models.Model):
    ...
    #
    #   در انتظار تأیید ──ادمین تأیید──▶ در انتظار پرداخت ──ثبت واریز──▶ پرداخت انجام شد
    #        │  ▲                             │
    ...
    def record_iban_check(self, check, *candidate_names):
        ...
        if ownership is True:
            ...
            # بررسی کند، پس مستقیم در انتظار پرداخت قرار می‌گیرد. اگر استعلام
