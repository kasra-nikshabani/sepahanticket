...
urlpatterns = [
    ...
    path('admin/match/<int:match_id>/stadium-layout/bulk-floor/<str:floor>/', views.admin_match_bulk_toggle_floor, name='admin_match_bulk_toggle_floor'),
    path('admin/match/<int:match_id>/stadium-layout/bulk-rows/<int:block_id>/', views.admin_match_bulk_toggle_rows, name='admin_match_bulk_toggle_rows'),
